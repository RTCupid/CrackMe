...
$(BIN_DIR)/a.exe: $(OBJ_DIR)/Tablet.o $(OBJ_DIR)/FreadFile.o $(OBJ_DIR)/main.o
	$(CC)  $(OBJ_DIR)/Tablet.o $(OBJ_DIR)/FreadFile.o $(OBJ_DIR)/main.o -o a.exe $(FLAGS)
...
$(OBJ_DIR)/main.o: main.cpp ./FreadFile/FreadFile.h ./Tablet/Tablet.h
